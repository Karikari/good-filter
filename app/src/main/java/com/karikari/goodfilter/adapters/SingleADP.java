...
public class SingleADP extends RecyclerView.Adapter<SingleADP.ViewHolder> {
    ...
    public SingleADP.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        if(orientation == 1){
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_text_horizontal, parent, false);
        }else{
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_text, parent, false);
